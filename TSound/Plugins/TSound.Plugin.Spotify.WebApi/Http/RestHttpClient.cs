...
namespace TSound.Plugin.Spotify.WebApi.Http
{
    /// <summary>
    ...
    public static class RestHttpClient
    {
        ...
        {
            return await http.Get(requestUri, null);
        }
        ...
        {
            return await http.Post(requestUri, formData, null);
        }
            ...
            AuthenticationHeaderValue headerValue)
        {
            ...
            var response = await http.PostAsync(requestUri, new StringContent(formData, Encoding.UTF8, "application/x-www-form-urlencoded"));
