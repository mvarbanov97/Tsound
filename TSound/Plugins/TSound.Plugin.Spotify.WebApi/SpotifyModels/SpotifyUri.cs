...
namespace TSound.Plugin.Spotify.WebApi.SpotifyModels
{
    public class SpotifyUri
    {
        ...
        public static readonly Regex SpotifyUserCollectionUriRegEx = new Regex("^spotify:user:[a-z0-9_-]+:collection:[a-z]+:[a-zA-Z0-9]+$");
        public static readonly Regex SpotifyIdRegEx = new Regex("^[a-zA-Z0-9]+$");
